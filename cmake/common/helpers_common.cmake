...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/src/diagnostics/log.c.in")
  configure_file(src/diagnostics/log.c.in diagnostics-log.c @ONLY)
  add_library(diagnostics-log STATIC)
  target_sources(diagnostics-log PRIVATE diagnostics-log.c PUBLIC src/diagnostics/log.h)
  target_include_directories(diagnostics-log PUBLIC "${CMAKE_CURRENT_SOURCE_DIR}/src")
  if(OS_LINUX OR OS_FREEBSD OR OS_OPENBSD)
    # add fPIC on Linux to prevent shared object errors
    set_property(TARGET diagnostics-log PROPERTY POSITION_INDEPENDENT_CODE ON)
  endif()
endif()
